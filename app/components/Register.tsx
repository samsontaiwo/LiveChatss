    ...
    return (
        <div>
            <form>
                ...
                <input value={name} type='text' id='name' placeholder='Fullname' onChange={(eve)=>handleNameChange(eve)}/> <br/>
                ...
                <input id='password' value={passw} type='text' placeholder={passwordPlaceHolder} onChange={(eve)=>handlePasswChange(eve)}/> <br/>
                <button type='submit' disabled={passw.length<1} >Create</button>
            </form>
